            ...
            <div className="video-content">
                ...
                <div style={{ display: "flex" }} className="content">
                    ...
                    <div className="channel-info">
                        <img className="pointer" style={{ borderRadius: "50%", width: "48px", height: "48px" }} src="https://yt3.googleusercontent.com/ytc/APkrFKaMHI0SOyDfYb7Sd1E6XgyrpmFQaiLsvApjZLsZuQ=s176-c-k-c0x00ffffff-no-rj" alt="" />
                        <div className="channel pointer">
                            <h4> <a href="https://www.youtube.com/@LivesAlanzoka">Lives do alanzoka ✓</a></h4>
                            <div>
                                <span style={{ padding:"0", fontSize: "13px" }}>3,33 mi de inscritos</span>
                            </div>
                        </div>
                        <div>
                ...
                <div className="views">
                    <h4 style={{ margin: "20px 0px", padding: "10px" }}>618.217 visualizações  1 de nov. de 2023</h4>
                    <div>
                        <p style={{ fontSize: "15px", padding: "10px" }}>QUINZENA DO CONSUMIDOR <br />
                            <br />
                            Ofertas insanas para quem é Ninja, com até 55% OFF! <br />
                            <a href="http://kb1.me/alanzokaquinzenalive">http://kb1.me/alanzokaquinzenalive</a> <br />
                            <br />
                            CUPOM? TEMOS! ALANZOKA5 com 5% CUMULATIVO em Headset Gamer, Teclado Gamer, Mouse Gamer, Streamer, Webcam, Kit Gamer, Teclado e Mouse, Gabinete e Mousepad. <br />
                            <br />
                        </p>
                    </div>
                </div>
